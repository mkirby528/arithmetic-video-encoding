...
public class StaticEncodingVideoSourceModel {
	public static void main(String[] args) throws IOException {
		String input_file_name = "assignment-data/inputToStaticSrcModel.dat";
		String output_file_name = "assignment-data/outputToStaticSrcModel.dat";
